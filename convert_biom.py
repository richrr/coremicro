...
#("The --biom_to_classic_table, --sparse_biom_to_dense_biom, "and --dense_biom_to_sparse_biom options are mutually exclusive. Pass only one at a time.")
def main_converter(input_fp, header_key, biom_to_classic_table=True):
    # \biom_type, sparse_biom_to_dense_biom, dense_biom_to_sparse_biom, process_obs_metadata,  sample_mapping_fp, obs_mapping_fp):
